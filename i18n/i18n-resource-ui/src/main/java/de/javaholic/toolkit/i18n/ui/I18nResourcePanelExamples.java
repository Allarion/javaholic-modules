...
// TODO: looose this class! move functionality, also rebuild use internal API for components (Buttons, Inputs)
public final class I18nResourcePanelExamples {

    private I18nResourcePanelExamples() {
    }
