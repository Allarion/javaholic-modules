...
public final class IamPanels {
    ...
    public IamPanels(PermissionCrudStoreAdapter permissionStore, RoleCrudStoreAdapter roleStore, UserCrudStoreAdapter userStore) {
        this.permissionStore = Objects.requireNonNull(permissionStore);
    ...
    public CrudPanel<Permission> permissions(PermissionCrudStoreAdapter permissionStore, Labels labels) {
